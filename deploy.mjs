...
console.log("GitHub", "https://github.com/webigorkiev/amitt/");
console.log("GitHub Pages", "https://webigorkiev.github.io/amitt/");
console.log("npm", "https://github.com/webigorkiev/amitt");
